(function(exports){
	...
	DrawPoints.prototype.draw = function(){
		...
		for (var l = this.triangles.length; l >= 3; l -= 3) {
			...
			this.ctx.beginPath();
			this.ctx.moveTo(this.vertices[this.triangles[l - 1]][0], this.vertices[this.triangles[l - 1]][
					1
			]);
			this.ctx.lineTo(this.vertices[this.triangles[l - 2]][0], this.vertices[this.triangles[l - 2]][
					1
			]);
			this.ctx.lineTo(this.vertices[this.triangles[l - 3]][0], this.vertices[this.triangles[l - 3]][
					1
			]);
			this.ctx.closePath();
			this.ctx.stroke();
